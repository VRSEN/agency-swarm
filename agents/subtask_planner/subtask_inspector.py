...
6. 确保<task_graph>中每个子任务的执行能力群"capability_group"名称正确且合理，所有能力群名称和介绍如下：
    ...
    h. "集群管理能力群": 集群管理能力群提供对华为云k8s集群（即CCE）的管理功能，包括创建、删除、查询、更新、休眠、唤醒、添加集群标签等核心操作，以及更改集群规格等扩展功能；
    i. "节点管理能力群": 节点管理能力群提供对CCE节点的管理功能，包括创建、删除、查询、更新等操作，以及节点池的管理和控制节点缩容保护。
