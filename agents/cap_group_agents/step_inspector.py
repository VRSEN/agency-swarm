...
注意：每次得到输入时，你都需要通过`ReadJsonFile`从completed_sub_tasks.json读取已完成的子任务，从context_tree.json中读取已完成任务产生的环境信息
...
4. 除非<user_request>或context_tree.json中有说明，否则任务执行环境最开始应该没有创建**任何资源**，确保每个任务所需资源应该在**前置任务**中有所创建；
