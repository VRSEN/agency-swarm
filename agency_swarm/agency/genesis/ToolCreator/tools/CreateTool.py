...
class CreateTool(BaseTool):
    ...
    agent_name: str = Field(..., description="Name of the agent to create the tool for.")
    tool_name: str = Field(..., description="Name of the tool class in camel case.", examples=["ExampleTool"])
    tool_code: str = Field(..., description="Complete tool code that should be written to the file.")
    agency_name: str = Field(None, description="Name of the agency. Defaults to the agency currently being created.")
