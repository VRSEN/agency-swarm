...
if __name__ == "__main__":
    ...
    test_queries = [
        ...
        },
        {
            ...
            "query": "I want to send an email to Sarah about the meeting tomorrow. I think we need to reschedule because I have a conflict. Can you draft this?",
        ...
        },
        {
            ...
            "query": "I need to email Mike at mike@company.com. Tell him the budget proposal looks good but we need to cut 10% from the marketing line. Make it sound diplomatic. Actually, after seeing the draft, I want you to make it more direct and mention specific numbers: reduce from $100k to $90k.",
            "expected": "Draft revision workflow: initial draft -> user feedback -> revised draft",
        },
        {
            "id": 4,
            "name": "Multiple Recipients",
            "query": "Send an email to the team at team@startup.com, and CC alice@startup.com and bob@startup.com. Subject should be 'Weekly Standup Recap'. Tell them we completed 3 user stories, deployed to staging, and the production release is scheduled for Friday. Keep it brief and bullet-pointed.",
            "expected": "Handle multiple recipients (To, CC) and structured content",
        },
        {
            "id": 5,
            "name": "Learning from Preferences",
            "query": "Email Jennifer at jennifer@consulting.com about our consultation call. I prefer a warm, personable tone and always sign off with 'Best regards'. Tell her I enjoyed our discussion about the AI strategy and I'm excited to collaborate. Suggest we schedule a follow-up next week.",
