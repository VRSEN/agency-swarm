...
class OrcaRouterChatCompletionsModel(OpenAIChatCompletionsModel):
    """OrcaRouter chat model with the OpenAI-compatible Chat Completions wire format.

    OrcaRouter is an OpenAI-compatible AI gateway. Unlike OpenRouter, it passes
    provider reasoning content through natively, so no reasoning normalization or
    replay override is required here.
    """
