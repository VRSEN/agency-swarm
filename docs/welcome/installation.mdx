...
<CardGroup cols={3}>
  ...
  <Card title="Use Agency Templates" icon="layer-group" iconType="duotone" href="https://github.com/agency-ai-solutions/agency-starter-template">
    Start with the production-ready [Agency Starter Template](https://github.com/agency-ai-solutions/agency-starter-template) to quickly get a working agency with real tools and examples.
  </Card>
