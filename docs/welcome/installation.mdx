...
<CardGroup cols={3}>
  ...
  <Card title="Use Agency Templates" icon="layer-group" iconType="duotone" href="./getting-started/agency-templates">
    Start with production-ready templates. Best for quickly getting a working agency with real tools and examples.
  </Card>
