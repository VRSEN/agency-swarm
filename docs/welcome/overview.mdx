...
<CardGroup cols={3}>
  <Card title="Install" icon="download" href="/welcome/installation">
    `pip install agency-swarm`
  </Card>
  <Card title="Starter Template" icon="layer-group" href="/welcome/getting-started/starter-template">
    One-click repo to get started fast
  </Card>
  <Card title="From Scratch" icon="code" href="/welcome/getting-started/from-scratch">
