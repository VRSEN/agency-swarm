...
<Note>
Use this guide when you need to build everything manually. Otherwise, start from the [Agency Starter Template](https://github.com/agency-ai-solutions/agency-starter-template).
</Note>
