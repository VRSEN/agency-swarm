...
icon: "plug"
---
import { Card, Accordion, Steps, Step } from "@mintlify/components";
...
*   **Remember:** The demo requires you to run the example SSE server ([server.py](https://github.com/VRSEN/agency-swarm/blob/main/tests/script/server.py)) in a separate terminal first.
