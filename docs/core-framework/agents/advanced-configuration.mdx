...
See also: [Output Validation](/additional-features/output-validation).

### Few-Shot Examples

Few-shot examples help the agent understand how to respond. Provide them at initialization; they will be appended to `instructions`. The format follows the [message object format](https://platform.openai.com/docs/api-reference/messages/createMessage):
