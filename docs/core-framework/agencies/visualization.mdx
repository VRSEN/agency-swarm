...
| `layout_algorithm` | `str` | `"force_directed"` | Layout: `"hierarchical"`, `"force_directed"`, `"circular"` |
| `include_tools` | `bool` | `True` | Whether to include agent tools |
| `open_browser` | `bool` | `True` | Whether to automatically open in browser |

#### Features

- **🎨 Design**: Gradients, shadows, and responsive layout
- **⚡ Force-directed Layout**: Force-directed layout with collision detection
- **🎯 Multiple Layouts**: Hierarchical, force-directed, and circular algorithms
...
- Subsequent layers arranged by communication flows
