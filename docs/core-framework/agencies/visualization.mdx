...
| `layout_algorithm` | `str` | `"hierarchical"` | Layout: `"hierarchical"`, `"force_directed"`, `"circular"` |
...
- **🎯 Intelligent Layouts**: Hierarchical (default), force-directed, and circular algorithms
- **🧠 Smart Tool Positioning**: Manager tools positioned to the right, leaf agent tools below
- **⚡ Collision Detection**: Optimized spacing (120px minimum) prevents node overlaps
- **🎮 Interactive Controls**: Drag nodes, zoom, pan, and layout switching
- **📊 Real-time Statistics**: Live agent, tool, and communication flow counts
- **💾 Export Options**: Download as SVG or PNG
- **📱 Responsive Design**: Works on desktop, tablet, and mobile
- **🛠️ Tool Management**: Toggle tool visibility dynamically
...
**Circular Layout**:
- Agents arranged in a circle with entry points at top
- Tools positioned inside the circle near parent agents
- Good for peer-to-peer communication patterns
