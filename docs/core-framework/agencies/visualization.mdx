...
| `layout_algorithm` | `str` | `"hierarchical"` | Layout algorithm: `"hierarchical"`, `"circular"`, `"force-directed"` |
...
- `"circular"` - Agents arranged in a circle
...
| `layout` | `str` | `"spring"` | Graph layout: `"spring"`, `"circular"`, `"hierarchical"`, `"shell"` |
...
**Circular layouts** work best for:
- Peer-to-peer collaboration patterns
- Agencies where all agents have similar roles
- Small agencies (3-6 agents)
