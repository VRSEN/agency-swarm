...
To enable asynchronous execution for agents, set the <Code>async_mode</Code> parameter to <Code>"threading"</Code> when initializing the agency.
...
To enable asynchronous execution for tools, set the <Code>async_mode</Code> parameter to <Code>"tools_threading"</Code>.
