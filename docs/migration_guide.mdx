...
**v1.x** (guardrails) - See [Breaking Changes](#breaking-changes) for details:
```python
@output_guardrail
...
**What Changed:**
- **Breaking Change**: `response_validator` parameter is completely removed from Agent class
...
## Complete Before/After Example {#complete-before-after-example}
