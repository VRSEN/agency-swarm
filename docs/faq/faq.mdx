...
**A**: Agents communicate using the <Code>SendMessage</Code> tool, with communication flows defined in the <Code>agency_chart</Code> parameter of the <Code>Agency</Code> class.
</Accordion>
