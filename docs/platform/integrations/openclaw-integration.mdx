...
<CardGroup cols={2}>
  ...
  <Card title="Starter Template Guide" icon="rocket" href="/welcome/getting-started/starter-template">
    Follow the same template-first deployment flow used across Agencii.
  </Card>
</CardGroup>
