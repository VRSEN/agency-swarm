...
## Set up n8n Integration in Agencii
...
## Install the Agencii Community Node in n8n
...
## Use the Agencii Node in a Workflow
...
For more details on the underlying node behavior and advanced patterns, see the [`n8n-nodes-agencii` package on npm](https://www.npmjs.com/package/n8n-nodes-agencii).
