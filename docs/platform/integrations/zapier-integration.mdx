...
Seamlessly connect your **agents** to **Zapier**, a platform that significantly simplifies Zapier Business profile setup.
...
- A verified **Zapier Account** ([Sign up here](https://zapier.com/)) with a provisioned phone number.

## Creating a Zapier Agent

<Steps>
  <Step title="Create a Zapier Agent">
    1. Go to [Zapier](https://zapier.com/) and click on the **'Create New Agent'** button to begin the setup.
