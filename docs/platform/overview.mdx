...
<Note>
To get access, please first create an account on the [Agencii Platform](https://app.agencii.ai). No payment card required :)
</Note>
...
To get started with the Agencii Platform, please sign up for a free account [here](https://app.agencii.ai/signup). 
