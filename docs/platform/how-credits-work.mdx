...
Credits are your usage balance on the platform. They cover everything your agents do—from quick replies to long-running, multi-step workflows in sandboxes.
...
<CardGroup cols={3}>
  ...
  <Card title="Refill Credits" icon="upload">
    Extra credits you can purchase anytime that never expire (optional auto-recharge on Pro).
  </Card>
</CardGroup>
