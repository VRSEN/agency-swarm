...
<CardGroup cols={3}>
  <Card title="Daily Credits" icon="circle-dollar">
    Use-it-or-lose-it credits that reset to 25 every day at midnight UTC.
  </Card>
  <Card title="Monthly Credits" icon="rocket">
    Your main monthly allocation, refreshed each billing cycle.
  </Card>
...
| --- | --- | --- | --- | --- | --- |
| **Daily** | All users (Free and Pro) | 25 credits per day | Every 24 hours at midnight UTC | No — unused daily credits reset and do not accumulate | Use-it-or-lose-it. Refreshes back to 25 every day at midnight UTC. |
| **Monthly** | Pro users only | 2,000 credits per month | At the start of each billing cycle | No — unused monthly credits do not carry over | Your subscription's main allocation. Refreshes when your billing cycle renews. |
| **Refill** | Anyone who purchases them | Based on purchase | One-time purchase | Yes — refill credits never expire | Extra credits you purchase when needed. |
