---
title: "OpenClaw"
description: "Deploy your own private OpenClaw assistant on Agencii."
icon: "lobster"
---

OpenClaw is a personal AI assistant you run in your own environment.
On Agencii, you can launch it from a ready template and chat with it inside your workspace in a few clicks.
...
<Steps>
  ...
  <Step title="Connect the repository">
    In Agencii, connect your GitHub account and pick the repository you created from the template.
  </Step>

  <Step title="Add your AI provider secrets">
    Add at least one model-provider key in **Secrets Vault** before you deploy. You only need the key for the provider your chosen model uses.
...
On Agencii, the full path is `/mnt/openclaw/.openclaw/workspace`.
...
3. Open `/mnt/openclaw/.openclaw/workspace`
...
- A private OpenClaw deployment running on Agencii
- Normal chat inside your Agencii workspace
...
The provider secrets you add in Agencii are available inside the sandbox so OpenClaw can call model providers.
