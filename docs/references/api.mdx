...
class Agent(BaseAgent[MasterContext]):
    def __init__(self, **kwargs: Any):
        ...
        Parameters:
            ...
            send_message_tool_class (type | None): [Deprecated] Agent-level override; configure SendMessage tools via
...
- **`send_message_tool_class`** (type | None): [Deprecated] Agent-level override; use `communication_flows` for tool selection
...
def register_subagent(
    ...
    Parameters:
        ...
        send_message_tool_class: Optional custom SendMessage override for this pair (deprecated; prefer
            assigning tool classes in `communication_flows`)
