...
class Agent(BaseAgent[MasterContext]):
    def __init__(self, **kwargs: Any):
        ...
        Parameters:
            ...
            include_web_search_sources (bool): Include full source URLs for WebSearchTool output (default True)
...
- **`include_web_search_sources`** (bool): Whether WebSearchTool responses include full checked source URLs
