...
class BaseTool(BaseModel, ABC):
    ...
    # Agency context and caller agent properties
    _shared_state: ClassVar[SharedState] = None  # Legacy: Manages agency context between tools (deprecated, use context inside of Function Tools)
