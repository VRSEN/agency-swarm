...
description: "Reference documentation for the Agencii Platform Web API."
icon: "globe"
---
...
| `attachments` | `array` | No | An array of attachment objects. See [Attachment Object](#attachment-object). | `[{"file_id": "file-123", "tools": [{"type": "file_search"}]}]` |
| `additionalInstructions` | `string` | No | Appends additional instructions at the end of the instructions for the run. This is useful for modifying the behavior on a per-run basis without overriding other instructions. | `"User name: John Smith"` |
...
| `tools` | `array` | **Yes** | An array of tool objects. See [Tool Object](#tool-object). |  |
...
| `message` | `object` | The message object containing the response details. | See [Message Object](#message-object) |
