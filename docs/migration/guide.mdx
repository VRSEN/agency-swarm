...
```bash
pip install -U "agency-swarm>=1.0.0-beta.4"
```
...
<Tip>
**Migration Strategy**: Start with the Quick Migration Checklist, then work through the step-by-step guide. The complete example shows a full before/after comparison.
</Tip>
