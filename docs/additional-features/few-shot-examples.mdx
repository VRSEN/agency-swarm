...
<Note>
The agent keeps these examples and automatically prepends them to every conversation at run time, so the model always sees them immediately after your core instructions.
</Note>
