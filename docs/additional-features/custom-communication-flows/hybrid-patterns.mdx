...
---
<Warning>
This feature is only available for newer versions of the library (v1.0 and higher)
</Warning>
...
✅ **Orchestrator Visibility**: Calling agents get informed about sequential handoff decisions
✅ **Internal Delegation**: Agents can use sequential handoffs for specialized processing
