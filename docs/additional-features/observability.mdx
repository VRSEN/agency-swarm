---
title: "Observability"
description: "Track and analyze agent behavior and performance through Langchain callbacks"
icon: "eyes"
---
...
Agency Swarm supports agent tracking through Langchain callbacks, helping you monitor and analyze agent behavior and performance.

<CardGroup cols={2}>
  <Card title="Langfuse" icon="chart-line" href="#langfuse">
    Advanced tracing, metrics, and debugging tools
  </Card>
  <Card title="AgentOps" icon="gauge-high" href="#agentops-wip">
