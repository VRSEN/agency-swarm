...
<Info>
  Agency Swarm provides flexible integration with various observability tools, allowing you to choose the best solution for your needs. You can use one or multiple trackers simultaneously.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Implementation" icon="code" href="#implementation-example">
