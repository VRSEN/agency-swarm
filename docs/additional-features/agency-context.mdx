...
<Info>
**Agency Context** was formerly known as **Shared State** in version 0.x of the Agency Swarm library. If you're migrating from v0.x, see the [Legacy Shared State (v0.x)](#legacy-shared-state-v0-x) section below.
</Info>
