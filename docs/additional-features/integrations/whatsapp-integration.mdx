...
- A verified **Facebook Business account** *****
    - A verified **WhatsApp Business Portfolio** *****

## Step 1: Create an WhatsApp Sender via Twilio
...
## Step 2: **Create a New WhatsApp Integration**
...
## Step 3: Select or create your Twilio Account
...
2. To add a new account, ****copy and paste your **Account SID** and **Auth Token** from the bottom of the Twilio dashboard.
    ...
    1. (Optional) If you have a Subaccount, paste the Subaccount SID as well.
3. Click **Create**

## Step 4: Add your WhatsApp Sender SID
...
**✅ That’s it! Your setup is complete—now you can start chatting with your WhatsApp chatbot.**