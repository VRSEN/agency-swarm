...
- `additional_instructions` (optional): Additional instructions that will be appeneded at the end of instructions for the recipient agent.
- `tool_choice` (optional): Force the recepient agent to use a specific tool.
