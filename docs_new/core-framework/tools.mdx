...
class GetWeatherTool(BaseTool):
    ...
    def run(self):
        ...
        return f"The weather in {self.location} is sunny with a temperature of 75°F."
```
...
1. **Provide Additional Instructions in the `run` Method:**
...
2. **Use `shared_state` to Validate Actions by Other Agents:**
...
3. **Consider `one_call_at_a_time` in `ToolConfig`:**
...
4. **Enable [Strict Mode](https://openai.com/index/introducing-structured-outputs-in-the-api/) for Complex or Mission-Critical Tools:**
