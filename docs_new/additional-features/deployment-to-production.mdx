...
icon: "rocket-launch"
---
To deploy your agency to production, you usually need to:
...
For detailed instructions, visit the link above and follow the instructions provided. A high-level overview of the steps:
1. Clone the Template and Add Your Agency Code
2. Configure Environment Variables
3. Generate and Test `settings.json`
4. Configure Railway and Deploy
...
Key steps include:
1. Click "Use this template" and add your tools code in the `functions/tools/` folder
2. Add yout project ID to the `.firebaserc` file
3. Add `GOOGLE_CLOUD_PROD_CREDENTIALS` as a secret in the repository settings
4. Your next push to the main branch will automatically deploy your tools to Firebase

<Note>
  When deploying tools separately, make sure there is proper authentication and secure communication between your agents and the tool APIs.
</Note>
